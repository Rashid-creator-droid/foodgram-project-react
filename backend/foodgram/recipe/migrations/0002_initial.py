...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='favorites',
            constraint=models.CheckConstraint(check=models.Q(('user', models.F('recipe')), _negated=True), name='favoriteuniq'),
        ),
        migrations.AddConstraint(
            model_name='basket',
        ...
        migrations.AddConstraint(
            model_name='basket',
            constraint=models.CheckConstraint(check=models.Q(('user', models.F('recipe')), _negated=True), name='basketuniq'),
        ),
    ]
